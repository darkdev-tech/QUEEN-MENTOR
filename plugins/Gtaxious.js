...
zokou({
  ...
  if (!arg || arg.length === 0) {
    const replyText = "Example Usage: .code 2541070xxxxx.";
    return repondre(replyText);
  }

  try {
    // Notify user that pairing is in progress
    const replyText = "```Wait DARK Md is getting your pair code ❤️💚...```";
      ...
      contextInfo: {
        forwardingScore: 999,
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: 143},
        externalAdReply: {
          title: "DARK-MD ELEMENT INFORMATION",
      ...
      contextInfo: {
        forwardingScore: 999,
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: 143},
        externalAdReply: {
          title: "DARK-MD GITHUB USER INFO",
